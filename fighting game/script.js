...
// apdejtuje stanje po proveri isOver
...
class Game {
  ...
  // klasa game koja pokrece i proverava da li je gotovo
...
let player1 = new Player('Dante',100,10)
let player2 = new Player('Andrew',100,10)
